...
<head>
  ...
  <style>
    body { 
      ...
      /* 🎨 如果你有自己的畫作網址，可以把下面這行換掉 */
      background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%); 
      margin: 0; padding: 20px; display: flex; justify-content: center; align-items: center; min-height: 100vh; 
    }
    .card { background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(10px); width: 100%; max-width: 500px; padding: 30px; border-radius: 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.1); }
...
<body>
  <div class="card">
    ...
    <div class="disclaimer">⚠️ <strong>免責聲明：</strong>本工具由 AI 產生，僅供法律參考。若遇重大爭議請諮詢工會。</div>
    <form action="/analyze" method="post" enctype="multipart/form-data">
      <textarea name="user_input" placeholder="描述狀況或上傳截圖..."></textarea>
